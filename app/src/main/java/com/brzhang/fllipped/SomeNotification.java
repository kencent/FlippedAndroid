...
import com.brzhang.fllipped.view.MainActivity;


/**
 * Helper class for showing and canceling some
 * notifications.
 * <p>
...
public class SomeNotification {
     ...
     */
    private static final String NOTIFICATION_TAG = "Some";
     ...
     * presentation of some notifications. Make
     * sure to follow the
    ...
    public static void notify(final Context context,
        ...
        pending.putExtra("key_fragment_index", 1);
